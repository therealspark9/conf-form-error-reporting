...
class ConsoleErrorMonitor {
  constructor(config = {}) {
    this.config = {
      ...
      locales: config.locales || ['en-US', 'pt-BR', 'es-ES', 'fr-FR', 'de-DE', 'ja-JP'],
  ...
  generateUrls() {
    ...
    const paths = [
      ...
      '/form/demo/conf/asyncconf',
      '/form/contact/conf/asyncconf',
      '/form/trial/conf/asyncconf',
      '/form/webinar/conf/asyncconf',
      '/products/platform/conf/asyncconf',
      '/products/sales/conf/asyncconf',
      '/products/service/conf/asyncconf',
      '/solutions/small-business/conf/asyncconf',
      '/solutions/enterprise/conf/asyncconf'
    ];
...
async function main() {
  ...
  const config = {
    ...
    locales: ['en-US', 'pt-BR', 'es-ES', 'fr-FR', 'de-DE', 'ja-JP', 'zh-CN', 'it-IT', 'nl-NL', 'sv-SE'],
    maxConcurrent: 10,
    timeout: 30000,
    outputDir: './reports',
    retryLimit: 2
